    ...
    <>
      <div className="hidden lg:flex">
        <ul className="fixed right-10 bottom-10 flex flex-col gap-5 items-center lg:bottom-40 xl:bottom-10 ">
          <li className="flex items-center  bg-blue-500/10  text-blue-500 py-3 px-3 rounded-full hover:bg-blue-500/20 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition animate-bounce">
            <a
