...
function RealAbout() {
  ...
  const journeyTimeline = [
    {
      ...
      description: "Took my first steps into web development through online resources and self-learning."
    },
    {
      year: "2021",
      title: "First Client Project",
      description: "Successfully delivered my first freelance project, a responsive website for a local business."
    },
    {
      year: "2022",
      title: "Expanded Tech Stack",
      description: "Mastered React and started exploring full-stack development with Node.js and MongoDB."
    },
    {
      year: "2023",
      title: "Open Source Contributor",
      description: "Began contributing to open-source projects and building a stronger presence in the dev community."
    },
    {
      year: "Now",
      title: "Seeking New Challenges",
      description: "Ready to take on more complex projects and continue growing as a developer."
    }
  ];
  ...
  const projects = [
    {
      ...
      description: "My personal portfolio showcasing my journey and projects, built with React and Tailwind CSS.",
      tech: ["React", "Tailwind CSS", "JavaScript"],
      color: "from-purple-500 to-indigo-600"
    },
    {
      name: "Weather Dashboard",
      description: "A responsive weather app that displays current conditions and forecasts using OpenWeather API.",
  ...
  // Personal interests
  const interests = [
    { name: "Web Development", icon: "👨‍💻", desc: "Building beautiful, functional interfaces that solve real problems." },
    { name: "Open Source", icon: "🌍", desc: "Contributing to the community and learning from other developers." },
    { name: "UI/UX Design", icon: "🎨", desc: "Creating intuitive, engaging user experiences that delight people." },
    { name: "Reading Tech Blogs", icon: "📚", desc: "Staying updated with the latest trends and best practices." },
    { name: "Learning New Technologies", icon: "🚀", desc: "Constantly expanding my skillset to build better solutions." },
    { name: "Problem Solving", icon: "🧩", desc: "Finding elegant solutions to complex technical challenges." }
  ];
        ...
        <div className="text-center mb-16">
          ...
          >
            ...
            <p className="text-xl max-w-2xl mx-auto text-gray-300 leading-relaxed">
              I create engaging digital experiences that live at the intersection of design and technology.
            </p>
          </motion.div>
        </div>
            ...
            <div className="rounded-2xl overflow-hidden shadow-xl bg-gray-900/70 backdrop-blur-sm border border-gray-800">
              ...
              <div className="relative">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-gray-900 via-black/70 to-transparent flex items-end">
                  ...
                  >
                    ...
                    <p className="text-blue-400 font-medium text-lg">Frontend Developer</p>
                    
                    {/* Social Links with hover effects */}
                    <div className="flex space-x-3 mt-4">
                      {/* GitHub */}
                      <a href="#github" className="w-10 h-10 rounded-full bg-gray-800/80 hover:bg-blue-600/80 flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-blue-500/20">
                      ...
                      {/* LinkedIn */}
                      <a href="#linkedin" className="w-10 h-10 rounded-full bg-gray-800/80 hover:bg-blue-600/80 flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-blue-500/20">
                        <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                          <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                        </svg>
                      </a>
                      {/* Twitter */}
                      <a href="#twitter" className="w-10 h-10 rounded-full bg-gray-800/80 hover:bg-blue-600/80 flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-blue-500/20">
                        <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                          <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"/>
                        </svg>
                      </a>
                      {/* Dribbble */}
                      <a href="#dribbble" className="w-10 h-10 rounded-full bg-gray-800/80 hover:bg-blue-600/80 flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-blue-500/20">
                        <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-300 mb-4 leading-relaxed">
                  I'm a self-taught frontend developer with a passion for creating beautiful, functional, and user-friendly websites. 
                  I enjoy turning complex problems into simple, beautiful, and intuitive designs.
                </p>
                <p className="text-gray-300 mb-6 leading-relaxed">
                  When I'm not coding or pushing pixels, you'll find me exploring new technologies, contributing to open-source projects, 
                  or enhancing my skills through online courses and tutorials.
                </p>
                ...
                <div className="space-y-4 mt-8">
                  <div className="flex items-center group">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-gray-200 group-hover:text-blue-400 transition-colors duration-300">your.email@example.com</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center group">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-gray-200 group-hover:text-blue-400 transition-colors duration-300">New Delhi, India</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center group">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-gray-200 group-hover:text-blue-400 transition-colors duration-300">Available for new projects</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="p-6">
                ...
                {activeTab === "journey" && (
                  ...
                  >
                    ...
                    <div className="pl-10 relative">
                      ...
                      <div className="absolute left-0 top-1 bottom-0 w-0.5 bg-gradient-to-b from-blue-500 via-purple-500 to-blue-300"></div>
                      ...
                      {journeyTimeline.map((item, index) => (
                        ...
                        >
                          ...
                          <div className="absolute left-0 top-2 w-6 h-0.5 bg-blue-500"></div>
                          
                          {/* Timeline dot with pulse effect */}
                          <div className="absolute -left-[9px] top-0.5 z-10">
                    ...
                    <div className="mt-10 p-6 rounded-lg bg-gradient-to-br from-blue-900/20 to-purple-900/20 border border-blue-800/30">
                      ...
                      <p className="text-gray-300 leading-relaxed">
                        My goal is to continue growing as a developer while creating meaningful web experiences 
                        that solve real problems. I'm particularly interested in exploring emerging technologies like 
                        Web3 and pushing the boundaries of what's possible on the web.
                      </p>
                    </div>
                  </motion.div>
                )}
                ...
                {activeTab === "interests" && (
                  ...
                  >
                      ...
                      {interests.map((interest, index) => (
                        ...
                        >
                          <div className="flex items-center mb-3">
                            ...
                            <h4 className="text-lg font-semibold text-white">{interest.name}</h4>
                          </div>
                    ...
                    <div className="mt-10 p-6 rounded-lg bg-gradient-to-br from-blue-900/20 to-purple-900/20 border border-blue-800/30">
                      <h4 className="text-lg font-bold text-white mb-3">A Bit More About Me</h4>
                      <p className="text-gray-300 mb-3 leading-relaxed">
                        I began my coding journey through self-learning and online resources. What started as curiosity has grown into a genuine passion for web development.
                      </p>
                      <p className="text-gray-300 leading-relaxed">
                        I'm constantly expanding my knowledge through coding challenges, building personal projects, and contributing to the developer community. I believe in writing clean, efficient code and creating intuitive user experiences.
                      </p>
                    </div>
                  </motion.div>
                )}
                      ...
                      {projects.map((project, index) => (
                        ...
                        >
                          <div className="p-6 relative">
                            ...
                            <h4 className="text-lg font-bold text-white mb-2 relative z-10">{project.name}</h4>
